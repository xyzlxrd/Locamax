...
public class Carro {
    ...
    public enum TipoCombustivel {
        ...
        Hibrido("Híbrido"), Flex("Flex"), Eletrico("Elétrico");
    ...
    public enum PotenciaMotor {
        Potencia1_0("1.0"), Potencia1_3("1.3"), Potencia1_4("1.4"), Potencia1_5("1.5"),
        Potencia1_6("1.6"), Potencia1_8("1.8"), Potencia2_0("2.0"), Potencia2_0a2_9("2.0 - 2.9");
    ...
    public enum Disponibilidade {
        Disponivel("Disponível"), Alugado("Alugado"), Manutencao("Em manutenção");
    ...
    public Carro() {} //Construtor sem Parâmetros (Criar objeto vazio e implementar os dados depois com setters)

    @Override
    public String toString() {

        return "ID: "+idCarro+" | Nome: "+nomeCarro+" | Placa: "+placa+" | Ano: "+modelo.getAnoFabricacao()+" | Disponibilidade: "+disponibilidade+"";
    }
    ...
    public boolean getAirbag() { return airbag; }
